...
namespace AquaEngine
{
	public static class Log
	{
		...
		public static void Trace(string msg) => _NativeLog(msg, 0);
		public static void Debug(string msg) => _NativeLog(msg, 1);
		public static void Info(string msg) => _NativeLog(msg, 2);
		public static void Warning(string msg) => _NativeLog(msg, 3);
