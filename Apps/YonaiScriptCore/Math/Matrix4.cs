/*
 * 
 * Sourced from https://github.com/Philip-Trettner/GlmSharp/blob/master/GlmSharp/GlmSharp/Mat4x4/mat4.cs
 * 
 */
...
namespace Yonai
{
	...
	public struct Matrix4 : IReadOnlyList<float>
	{
		#region Fields
		...
		/// From Mat3
		/// </summary>
		public Matrix4(float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22)
		{
			this.m00 = m00;
			this.m01 = m01;
			this.m02 = 0f;
		...
		/// Creates a rotation matrix from a Quaternion.
		/// </summary>
		public static explicit operator Matrix4(Quaternion q) => q.ToMat4;
		...
		/// </summary>
		public static Matrix4 Ones { get; } = new Matrix4(1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f);
		...
		/// </summary>
		public static Matrix4 AllMaxValue { get; } = new Matrix4(float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue);

		/// <summary>
		/// Predefined diagonal-MaxValue matrix
		/// </summary>
		public static Matrix4 DiagonalMaxValue { get; } = new Matrix4(float.MaxValue, 0f, 0f, 0f, 0f, float.MaxValue, 0f, 0f, 0f, 0f, float.MaxValue, 0f, 0f, 0f, 0f, float.MaxValue);

		/// <summary>
		/// Predefined all-MinValue matrix
		/// </summary>
		public static Matrix4 AllMinValue { get; } = new Matrix4(float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue, float.MinValue);

		/// <summary>
		/// Predefined diagonal-MinValue matrix
		/// </summary>
		public static Matrix4 DiagonalMinValue { get; } = new Matrix4(float.MinValue, 0f, 0f, 0f, 0f, float.MinValue, 0f, 0f, 0f, 0f, float.MinValue, 0f, 0f, 0f, 0f, float.MinValue);

		/// <summary>
		/// Predefined all-Epsilon matrix
		/// </summary>
		public static Matrix4 AllEpsilon { get; } = new Matrix4(float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon);

		/// <summary>
		/// Predefined diagonal-Epsilon matrix
		/// </summary>
		public static Matrix4 DiagonalEpsilon { get; } = new Matrix4(float.Epsilon, 0f, 0f, 0f, 0f, float.Epsilon, 0f, 0f, 0f, 0f, float.Epsilon, 0f, 0f, 0f, 0f, float.Epsilon);

		/// <summary>
		/// Predefined all-NaN matrix
		/// </summary>
		public static Matrix4 AllNaN { get; } = new Matrix4(float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN, float.NaN);

		/// <summary>
		/// Predefined diagonal-NaN matrix
		/// </summary>
		public static Matrix4 DiagonalNaN { get; } = new Matrix4(float.NaN, 0f, 0f, 0f, 0f, float.NaN, 0f, 0f, 0f, 0f, float.NaN, 0f, 0f, 0f, 0f, float.NaN);

		/// <summary>
		/// Predefined all-NegativeInfinity matrix
		/// </summary>
		public static Matrix4 AllNegativeInfinity { get; } = new Matrix4(float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity);

		/// <summary>
		/// Predefined diagonal-NegativeInfinity matrix
		/// </summary>
		public static Matrix4 DiagonalNegativeInfinity { get; } = new Matrix4(float.NegativeInfinity, 0f, 0f, 0f, 0f, float.NegativeInfinity, 0f, 0f, 0f, 0f, float.NegativeInfinity, 0f, 0f, 0f, 0f, float.NegativeInfinity);

		/// <summary>
		/// Predefined all-PositiveInfinity matrix
		/// </summary>
		public static Matrix4 AllPositiveInfinity { get; } = new Matrix4(float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity);

		/// <summary>
		/// Predefined diagonal-PositiveInfinity matrix
		/// </summary>
		public static Matrix4 DiagonalPositiveInfinity { get; } = new Matrix4(float.PositiveInfinity, 0f, 0f, 0f, 0f, float.PositiveInfinity, 0f, 0f, 0f, 0f, float.PositiveInfinity, 0f, 0f, 0f, 0f, float.PositiveInfinity);
		...
		/// </summary>
		public static Matrix4 CompMul(Matrix4 A, Matrix4 B) => new Matrix4(A.m00 * B.m00, A.m01 * B.m01, A.m02 * B.m02, A.m03 * B.m03, A.m10 * B.m10, A.m11 * B.m11, A.m12 * B.m12, A.m13 * B.m13, A.m20 * B.m20, A.m21 * B.m21, A.m22 * B.m22, A.m23 * B.m23, A.m30 * B.m30, A.m31 * B.m31, A.m32 * B.m32, A.m33 * B.m33);

		/// <summary>
		/// Executes a component-wise / (divide).
		/// </summary>
		public static Matrix4 CompDiv(Matrix4 A, Matrix4 B) => new Matrix4(A.m00 / B.m00, A.m01 / B.m01, A.m02 / B.m02, A.m03 / B.m03, A.m10 / B.m10, A.m11 / B.m11, A.m12 / B.m12, A.m13 / B.m13, A.m20 / B.m20, A.m21 / B.m21, A.m22 / B.m22, A.m23 / B.m23, A.m30 / B.m30, A.m31 / B.m31, A.m32 / B.m32, A.m33 / B.m33);

		/// <summary>
		/// Executes a component-wise + (add).
		/// </summary>
		public static Matrix4 CompAdd(Matrix4 A, Matrix4 B) => new Matrix4(A.m00 + B.m00, A.m01 + B.m01, A.m02 + B.m02, A.m03 + B.m03, A.m10 + B.m10, A.m11 + B.m11, A.m12 + B.m12, A.m13 + B.m13, A.m20 + B.m20, A.m21 + B.m21, A.m22 + B.m22, A.m23 + B.m23, A.m30 + B.m30, A.m31 + B.m31, A.m32 + B.m32, A.m33 + B.m33);

		/// <summary>
		/// Executes a component-wise - (subtract).
		/// </summary>
		public static Matrix4 CompSub(Matrix4 A, Matrix4 B) => new Matrix4(A.m00 - B.m00, A.m01 - B.m01, A.m02 - B.m02, A.m03 - B.m03, A.m10 - B.m10, A.m11 - B.m11, A.m12 - B.m12, A.m13 - B.m13, A.m20 - B.m20, A.m21 - B.m21, A.m22 - B.m22, A.m23 - B.m23, A.m30 - B.m30, A.m31 - B.m31, A.m32 - B.m32, A.m33 - B.m33);
		...
		{
			var tmp = proj * (model * new Vector4(obj, 1));
			tmp /= tmp.w;
			tmp = tmp * 0.5f + 0.5f;
		...
		/// </summary>
		public static Vector3 UnProjectFaster(Vector3 win, Matrix4 model, Matrix4 proj, Vector4 viewport)
		{
			var tmp = new Vector4(win, 1);
			tmp.x = (tmp.x - viewport.x) / viewport.z;
			tmp.y = (tmp.y - viewport.y) / viewport.w;
		...
		{
			return Rotate(angle, Vector3.Left);
		}
